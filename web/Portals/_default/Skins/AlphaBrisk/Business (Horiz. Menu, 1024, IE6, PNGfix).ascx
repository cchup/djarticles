...
<!--[if LT IE 7]>
<script src="<%= SkinPath %>ie6/iepng.js" type="text/javascript"></script>
...
<div id="Brisk_wrapper">
	 		...
	 		<div id="options" style="display:none;">
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
						<li title="business" id="business" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/business.gif" alt="Business" /></li>
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/business.css" UseSkinPath="true" />
