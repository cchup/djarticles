...
<asp:panel id="pnlSettings" runat="server">
  ...
  <table id="tblCommOpt" runat="server" style="margin-left:20px; width:100%;">
       ...
       <asp:DataGrid id="grdTagList" Width="100%" runat="server" AutoGenerateColumns="False" BorderColor="Gray" BorderWidth="1px" Visible="false">
		<Columns>
			...
			<asp:TemplateColumn>
				...
				<ItemStyle HorizontalAlign="left"></ItemStyle>
				<ItemTemplate>
					<asp:ImageButton id="btnDelete" AlternateText="Item l鰏chen" ImageUrl="~/images/delete.gif" CssClass="CommandButton"
						runat="server"></asp:ImageButton>
				</ItemTemplate>
			</asp:TemplateColumn>
      ...
      <td>
        <table id="tCustomTag" style="width:100%;" runat="server" visible="false">
         <tr>
            ...
            <td valign="top"><asp:TextBox id="tbCustomTag" runat="server" Width="194px" Visible="false"></asp:TextBox></td>
          </tr>
          <tr>
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id="tbOccurCount" Width="50px" runat="server"></asp:TextBox>&nbsp;
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id="tbTags" Width="50px" runat="server"></asp:TextBox>&nbsp;
    ...
    <tr>
      ...
      <td><asp:TextBox id="tbTagsCloudWidth" Width="50px" runat="server"></asp:TextBox>&nbsp;
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id="tbTagsCloudHeight" Width="50px" runat="server"></asp:TextBox>&nbsp;
    ...
    <tr>
      ...
      <td>
          <asp:TextBox id="txtTagSeparator" runat="server" Width="194px"></asp:TextBox>
      </td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td>
        <asp:TextBox id="tbExlusLst" runat="server" Width="194px"></asp:TextBox>&nbsp;<asp:ImageButton id="iBAdd" runat="server" ImageUrl="~/images/add.gif" />
      </td>
    </tr>
    <tr>
      <td></td>
  ...
  <table id="tblFlashOpt" runat="server" style="margin-left:20px; width:100%;">
   <tr>
    ...
    <tr>
      ...
      <td>
        #<asp:TextBox id="tbTcolor" runat="server" Width="100px"></asp:TextBox><span id="Tcolor" class="ColorPicker"></span>&nbsp;<em><asp:Label id="lblColPic1" runat="server" Text="<--"></asp:Label></em>
    ...
    <tr>
      ...
      <td>
        #<asp:TextBox id="tbTcolor2" runat="server" Width="100px"></asp:TextBox><span id="Tcolor2" class="ColorPicker"></span>&nbsp;<em><asp:Label id="lblColPic2" runat="server" Text="<--"></asp:Label></em>
      </td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td>
        #<asp:TextBox id="tbHicolor" runat="server" Width="100px"></asp:TextBox><span id="Hicolor" class="ColorPicker"></span>&nbsp;<em><asp:Label id="lblColPic3" runat="server" Text="<--"></asp:Label></em>
      </td>
    </tr>
    <tr>
      <td valign="top">
      ...
      <td>
        #<asp:TextBox id="tbBgcolor" runat="server" Width="100px"></asp:TextBox><span id="Bgcolor" class="ColorPicker"></span>&nbsp;<em><asp:Label id="lblColPic4" runat="server" Text="<--"></asp:Label></em>
      </td>
    </tr>
    <tr>
      <td valign="top">
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id="tbTspeed" runat="server" Width="50px"></asp:TextBox>
