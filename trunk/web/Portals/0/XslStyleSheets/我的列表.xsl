...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:udt="DotNetNuke/UserDefinedTable" exclude-result-prefixes="udt">
  ...
  <xsl:template match="udt:Data" mode="list">
    <p class="Normal" style="padding:5px 0px 5px 0px;">
      ...
      </span>  发表于：<xsl:value-of select="udt:Created_x0020_at_UDT_Value" disable-output-escaping="yes" /><xsl:call-template name="EditLink" /><br /><xsl:value-of select="udt:我来说两句" disable-output-escaping="yes" /><br /></p>
    <hr />
  </xsl:template>
