...
<div id="Brisk_wrapper">
				...
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
							...
							<li title="toyama" id="toyama" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/toyama.gif" alt="Toyama" /></li>
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/toyama.css" UseSkinPath="true" />
