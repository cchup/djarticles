...
<div id="Brisk_wrapper">
				...
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
							...
							<li title="seasky" id="seasky" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/seasky.gif" alt="Seasky" /></li>
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/seasky.css" UseSkinPath="true" />
