				...
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
							...
							<li title="vista" id="vista" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/vista.gif" alt="Vista" /></li>
...
<div class="leftnav float_left">
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/vista.css" UseSkinPath="true" />
