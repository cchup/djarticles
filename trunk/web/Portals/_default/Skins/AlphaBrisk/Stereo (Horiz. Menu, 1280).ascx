...
<div id="Brisk_wrapper">
				...
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
							...
							<li title="stereo" id="stereo" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/stereo.gif" alt="Stereo" /></li>
						</ul>
					</div>
				<div id="layout">
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/stereo.css" UseSkinPath="true" />
