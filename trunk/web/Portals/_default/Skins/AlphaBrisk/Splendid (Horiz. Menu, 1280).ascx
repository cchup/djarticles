...
<div id="Brisk_wrapper">
				...
				<img src="<%= SkinPath %>images/close.png" onclick="disablePopups()" class="close" alt="Close" />
					<div id="themes">
						...
						<ul>
							...
							<li title="splendid" id="splendid" class="selected"><img src="<%= SkinPath %>images/background/thumbnail/splendid.gif" alt="Splendid" /></li>
    ...
    <dnn:STYLES runat="server" id="cssflie"  Name="cssfile" StyleSheet="css/theme/splendid.css" UseSkinPath="true" />
