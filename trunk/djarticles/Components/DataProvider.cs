...
namespace DjArticles.Components
{
    ...
    public abstract class DataProvider
    {
        ...
        public abstract int AddCategory(string Name, string Description, int ParentID, int Depth, int ViewOrder, string AdminRoles, string EditRoles, string ViewRoles, int CreatedByUserID, string CreatedByUserName, DateTime CreatedDate, bool IsActive, bool IsSpecial);
        ...
        public abstract IDataReader GetPassedArticlesByPage(int categoryId, int pageSize, int currentPage, DbParameter paTotalCount);
        ...
        public abstract void UpdateCategory(int CategoryID, string Name, string Description, int ParentID, int Depth, int ViewOrder, string AdminRoles, string EditRoles, string ViewRoles, string CreatedByUserName, int createByUserId, DateTime CreatedDate, bool IsActive, bool IsSpecial);
